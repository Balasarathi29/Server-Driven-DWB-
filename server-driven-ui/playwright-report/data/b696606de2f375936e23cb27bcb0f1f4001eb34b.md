...
- Name: roundtrip.spec.ts >> JSON roundtrip >> exact string preserved
- Location: tests\roundtrip.spec.ts:59:7
...
Expected: "{ \"ROOT\": { \"type\": { \"resolvedName\": \"Container\" }, \"isCanvas\": true, \"nodes\": [], \"props\": {} } }"
